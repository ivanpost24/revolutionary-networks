...
## Available Metadata, pulled from 40,691 documents. This data has been created by Rotunda from its internal metadata, and does not include any transcripts from the actual letters. 
